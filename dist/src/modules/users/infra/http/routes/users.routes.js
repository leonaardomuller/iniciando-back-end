...
var userAvatarControler = new UserAvatarController_1.default();
usersRouter.post('/', usersController.create);
usersRouter.patch('/avatar', ensureAuthenticated_1.default, upload.single('avatar'), userAvatarControler.update);
