    ...
    it('should be able to show the profile', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    profile = _a.sent();
                    expect(profile.name).toBe('John Lennon');
                    expect(profile.email).toBe('johnlennon@example.com');
                    return [2 /*return*/];
            }
        });
    }); });
    it('should not be able to show the profile from non-existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
