...
var UpdateProfileService = /** @class */ (function () {
    ...
    UpdateProfileService.prototype.execute = function (_a) {
        var user_id = _a.user_id, name = _a.name, email = _a.email, password = _a.password, old_password = _a.old_password;
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (password && !old_password) {
                            throw new AppError_1.default('You need to inform the old password first.');
                        }
    ...
    UpdateProfileService = __decorate([
        ...
        __param(1, tsyringe_1.inject('IHashProvider')),
